@extends('layouts.app')
@section('title', __('ui.pg_add_achievement'))
@section('page-title', __('ui.pg_add_achievement'))
@section('content')
<div class="chart-card" style="max-width:680px">
    <div class="card-title"><i class="bi bi-trophy me-2" style="color:#ca8a04"></i>{{ __('ui.pg_add_achievement') }}</div>
    <form action="{{ route('achievements.store') }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <input type="date" name="achieved_date" class="form-control @error('achieved_date') is-invalid @enderror" value="{{ old('achieved_date', now()->toDateString()) }}" required>
